<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:56:"./application/admin/template/guestbook\attribute_add.htm";i:1573115083;s:58:"D:\WWW\haiwei\application\admin\template\public\layout.htm";i:1571728724;s:58:"D:\WWW\haiwei\application\admin\template\public\footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <?php if(is_array($attrInputTypeArr) || $attrInputTypeArr instanceof \think\Collection || $attrInputTypeArr instanceof \think\Paginator): $i = 0; $__LIST__ = $attrInputTypeArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <option value="<?php echo $key; ?>" <?php if($i == '1'): ?>selected="true"<?php endif; ?>><?php echo $vo; ?></option>
