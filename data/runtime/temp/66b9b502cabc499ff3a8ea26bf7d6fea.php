<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:46:"./application/admin/template/download\edit.htm";i:1573695219;s:58:"D:\WWW\haiwei\application\admin\template\public\layout.htm";i:1571728724;s:63:"D:\WWW\haiwei\application\admin\template\field\addonextitem.htm";i:1573695224;s:71:"D:\WWW\haiwei\application\admin\template\diy_extend\archives_extend.htm";i:1571728724;s:58:"D:\WWW\haiwei\application\admin\template\public\footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
                                            ...
                                            <div class="template_div">
                                                ...
                                                <?php if(is_array($attr_field) || $attr_field instanceof \think\Collection || $attr_field instanceof \think\Paginator): $i = 0; $__LIST__ = $attr_field;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$f_vo): $mod = ($i % 2 );++$i;?>
                                                    <span class="ey_<?php echo $f_vo['field_name']; ?>">
                                                        <span class="title_<?php echo $f_vo['field_name']; ?>"><?php echo $f_vo['field_title']; ?></span>：<input type="text" name="<?php echo $f_vo['field_name']; ?>[]" value="<?php if($f_vo['field_name'] == 'server_name'): ?> <?php echo $vo['title']; else: ?> <?php echo $vo[$f_vo['field_name']]; endif; ?>" style="width: 7%;">
                                                    </span>
                                                <?php endforeach; endif; else: echo "" ;endif; ?>
                                            </div>
