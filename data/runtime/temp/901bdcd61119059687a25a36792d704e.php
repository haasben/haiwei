<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:51:"D:\WWW\haiwei/application/index\view\gywm\hjaq.html";i:1576744112;s:51:"D:\WWW\haiwei\application\index\view\gywm\head.html";i:1577173633;s:53:"D:\WWW\haiwei\application\index\view\common\left.html";i:1577173810;s:55:"D:\WWW\haiwei\application\index\view\common\footer.html";i:1577151019;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
		...
		<div class="banner">
			...
			<div class="container">
				...
				<div class="row box box1">
					...
					<ul class="env_list">
						<?php if(is_array($archives_data) || $archives_data instanceof \think\Collection || $archives_data instanceof \think\Paginator): $i = 0; $__LIST__ = $archives_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
						<li>
							<a href="/gywm/hjaq_info?id=<?php echo $cate_data['id']; ?>&typeid=<?php echo $v['id']; ?>">
								<img src="<?php echo $v['litpic']; ?>" title="<?php echo $v['typename']; ?>">
